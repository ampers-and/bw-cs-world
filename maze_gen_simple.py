...
def build_grid(x, y, w):
    for i in range(1, 21):
        # set coordinate x to start position
        x = 20
        # start a new row
        y = y + 20
...
#     # used to re-color the path after single_cell
